...
function plst(json) {
	...
	var randcatgr = json.entry.category, randcat = randcatgr.sort(), myTLDom = json.entry.link[2].href.replace("https://","").replace(/\/[^/]+(\.[^/.]+)$/,"").split("/"), awRanapiurl = "https://"+myTLDom[0]+'/feeds/posts/default/-/', akhRanapiurl = '?max-results=1&alt=json&callback=';
