...
function plst(json) {
	...
	var randcatgr = endata.category, randcat = randcatgr.sort(), myTLDom = endata.link[2].href.replace("https://","").replace(/\/[^/]+(\.[^/.]+)$/,"").split("/"), awRanapiurl = "https://"+myTLDom[0]+'/feeds/posts/default/-/', akhRanapiurl = '?max-results=1&alt=json&callback=';
