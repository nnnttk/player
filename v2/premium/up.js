...
function plst(json) {
	...
	for (var i = 0; i < 69; i++) {	
		var ranapiurl = awRanapiurl+randcat[i]+akhRanapiurl+'plst'+(i+1), script = document.createElement('script');script.setAttribute('src', ranapiurl); document.head.appendChild(script); 
